...
namespace SWARM.Server.Controllers.Application
{
    public class EnrollmentController : BaseController, iBaseController<Enrollment>
    {
        ...
        Task<IActionResult> iBaseController<Enrollment>.Delete(int keyvalue)
        {
            throw new NotImplementedException();
        }

        Task<IActionResult> iBaseController<Enrollment>.Get()
        {
            throw new NotImplementedException();
        }

        Task<IActionResult> iBaseController<Enrollment>.Get(int keyvalue)
        {
            throw new NotImplementedException();
        }
    }
